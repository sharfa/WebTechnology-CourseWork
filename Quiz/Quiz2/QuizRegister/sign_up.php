...
<link rel="StyleSheet" type="text/css" href="countries.css"/>
 ...
 <header>
<ul id="ul1">
  <li><a class="active" href="../../../Homeage/HomePage.html">Home</a></li>
  <li class="dropdown">
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="../../../Store/products1.php">Souvenir</a>
      <a href="../../../Store/products2.php">Books</a>
      <a href="../../../Store/products3.php">Accessories</a>
    </div>
  </li>
...
<table width=450 height=450 align="left" >
 ...
 <legend><FONT FACE="Geneva, Arial" SIZE=4>Registration Form</legend> 
 <table border="0"> 
 <tr> 
 <form method="POST" action="connectivity_sign-up.php">
 <td>Name</td>
 ...
 <td>
 <img src = "one-and-only-reethi-rah-maldives-location.jpg" style="width:300px;height:400px;">
 </td>
 </tr>
 </table>
 </fieldset> 
